...
export default function Page() {
  ...
  return (
    <div className=''>
      <div className='max-w w-full h-screen flex flex-col justify-top items-left p-8 bg-white rounded-lg shadow-md'>
        <div className='mb-4'>
          <button onClick={() => router.back()} className='text-gray-500 focus:outline-none'>
        ...
        <h2 className='text-3xl font-semibold text-left text-gray-800 mb-16'>Log in</h2>
        {error && (
        ...
        <form onSubmit={handleLogin}>
          ...
          <input
            ...
            className='w-full p-3 mb-4 text-lg rounded border border-gray-300 focus:outline-none focus:ring'
            type='email'
            name='email'
            placeholder='Email'
            required
          ...
          <input
            ...
            className='w-full p-3 mb-4 text-lg rounded border border-gray-300 focus:outline-none focus:ring focus:border-red-500'
            type='password'
            name='password'
          ...
          <div style={{ padding: '185px' }}></div> {/* Add padding */}
          <button className='w-full p-3 mb-4 bg-green-500 text-white text-lg rounded hover:bg-green-600' type='submit'>
            Log in
          </button>
        </form>
        <div className='text-center flex justify-center'>
          <p className='text-lg'>First time here?</p>
          <div style={{ padding: '8px' }}></div> {/* Add padding */}
